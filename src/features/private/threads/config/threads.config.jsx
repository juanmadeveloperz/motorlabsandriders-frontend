...
export const getColumnsConfig = ({ handleDelete, handleEdit }) => {
  return [
    ...
    {
      accessorKey: "title",
      header: ({ column }) => <Sorting column={column} title="Título" />,
      meta: "Título",
    },
    {
      accessorKey: "content",
      header: ({ column }) => <Sorting column={column} title="Contenido" />,
      meta: "Contenido",
    },
    {
    ...
    },
    {
      ...
      header: ({ column }) => <Sorting column={column} title="Categoría" />,
      meta: "Categoría",
    },
    {
      header: "Acciones",
